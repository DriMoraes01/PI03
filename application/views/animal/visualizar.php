                            ...
                            <div class="card-body">
                                <form class="forms-sample" id="form_core" name="form_core" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-2 mb-20">
                                            <label for="nome">Nome do Animal</label>
                                            <input type="text" class="form-control" id="nome" name="nome" value="<?= isset($animal) ? $animal->nome : ''; ?>" style="text-transform: uppercase;" readonly aria-readonly="true">
                                        </div>
                                        <div class="col-md-2 mb-20">
                                            <label for="castrado">Castrado</label>
                                            <input type="text" class="form-control" name="castrado" id="castrado" value="<?= ($animal->castrado == '0') ? 'Não' : 'Sim'; ?>" readonly aria-readonly="true">
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="sexo">Sexo</label>
                                                <input type="text" id="sexo" class="form-control" name="sexo" value="<?= isset($animal) ? $animal->sexo : ''; ?>" readonly aria-readonly="true">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="data_cadastro">Data de Cadastro</label>
                                                <input type="text" id="data_cadastro" class="form-control" name="data_cadastro" value="<?= isset($animal) ? formata_data_banco_sem_hora($animal->data_cadastro) : ''; ?>" readonly aria-readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="cor">Cor</label>
                                                <input type="text" class="form-control" id="cor" name="cor" value="<?= isset($animal) ? $animal->cor : ''; ?>" readonly aria-readonly="true">
                                            </div>
                                        </div>
                                        <div class="col-md-2 mb-20">
                                            <label for="raca">Raça</label>
                                            <input type="text" id="raca" class="form-control" name="raca" value="<?= isset($animal) ? $animal->raca : ''; ?>" readonly aria-readonly="true">
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="porte">Porte</label>
                                                <input type="text" id="porte" class="form-control" name="porte" value="<?= isset($animal) ? $animal->porte : ''; ?>" readonly aria-readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="observacao">Observação:</label>
                                                <input type="text" class="form-control" id="observacao" name="observacao" value="<?= isset($animal) ? $animal->observacao : ''; ?>" readonly aria-readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    <?php if (isset($animal)) : ?>
