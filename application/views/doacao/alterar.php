                            ...
                            <div class="card-body">
                                <form class="forms-sample" id="form_core" name="form_core" method="POST" aria-labelledby="formTitle">
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12 ml-20">
                                                <button type="submit" class="btn btn-success mr-2" aria-label="Salvar doação">Salvar</button>
                                                <a href="<?= base_url($this->router->fetch_class()); ?>" class="btn btn-primary" aria-label="Voltar para a lista de doações">Voltar</a>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
