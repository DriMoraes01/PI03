                            ...
                            <div class="card-body">
                                <form class="forms-sample" id="form_core" name="form_core" method="POST" aria-describedby="formInstructions">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6 mb-20">
                                            <label for="nome">Nome</label>
                                            <input type="text" class="form-control" id="nome" name="nome" value="<?= isset($doacao) ? $doacao->nome : ''; ?>" style="text-transform: uppercase;" readonly="" aria-readonly="true">
                                        </div>
                                        <div class="col-md-2">
                                            <label for="cpf">CPF</label>
                                            <input type="text" class="form-control" id="cpf" name="cpf" value="<?= isset($doacao) ? $doacao->cpf : ''; ?>" readonly="" aria-readonly="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-2 mt-10">
                                            <label for="valor">Valor</label>
                                            <input type="text" id="valor" class="form-control" name="valor" value="<?= isset($doacao) ? $doacao->valor : ''; ?>" readonly="" aria-readonly="true">
                                        </div>
                                        <div class="col-md-2 mt-10">
                                            <label for="data_doacao">Data da Doação</label>
                                            <input type="text" class="form-control" id="data_doacao" name="data_doacao" value="<?= isset($doacao) ? formata_data_banco_sem_hora($doacao->data_doacao) : ''; ?>" readonly="" aria-readonly="true">
                                        </div>
                                        <div class="col-md-4 mt-10">
                                            <label for="email">E-mail</label>
                                            <input type="email" class="form-control" id="email" name="email" value="<?= isset($doacao) ? $doacao->email : ''; ?>" readonly="" aria-readonly="true">
                                        </div>
                                    </div>
