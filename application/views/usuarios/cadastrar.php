                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <?= (isset($usuario) ? '<i class="ik ik-calendar ik-2x" aria-hidden="true"></i>&nbsp;Data da última alteração: &nbsp;' . formata_data_banco_com_hora($usuario->ultima_alteracao) : ''); ?>
                        </div>
                        <div class="card-body">
                            <form class="forms-sample" name="form_core" method="POST" aria-labelledby="formTitle">
                                <h2 id="formTitle" class="sr-only">Formulário de Cadastro de Usuário</h2>
                                <div class="form-group row">
                                    <div class="col-md-6 mb-20">
                                        <label for="first_name">Nome</label>
                                        <input type="text" id="first_name" class="form-control" name="first_name" value="<?= (isset($usuario) ? $usuario->first_name : set_value('first_name')); ?>" aria-required="true">
                                        <?= form_error('first_name', '<div class="text-danger" role="alert">', '</div>'); ?>
                                    </div>
                                    <div class="col-md-6 mb-20">
                                        <label for="last_name">Sobrenome</label>
                                        <input type="text" id="last_name" class="form-control" name="last_name" value="<?= (isset($usuario) ? $usuario->last_name : set_value('last_name')); ?>" aria-required="true">
                                        <?= form_error('last_name', '<div class="text-danger" role="alert">', '</div>'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6 mb-20">
                                        <label for="username">Usuário</label>
                                        <input type="text" id="username" class="form-control" name="username" value="<?= (isset($usuario) ? $usuario->username : set_value('username')); ?>" aria-required="true">
                                        <?= form_error('username', '<div class="text-danger" role="alert">', '</div>'); ?>
                                    </div>
                                    <div class="col-md-6 mb-20">
                                        <label for="email">E-mail (Login)</label>
                                        <input type="email" id="email" class="form-control" name="email" value="<?= (isset($usuario) ? $usuario->email : set_value('email')); ?>" aria-required="true">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <input type="password" id="password" class="form-control" name="password" value="" aria-required="true">
                                        <?= form_error('password', '<div class="text-danger" role="alert">', '</div>'); ?>
                                    </div>
                                    <div class="col-md-6 mb-20">
                                        <label for="confirmacao">Confirmação de Senha</label>
                                        <input type="password" id="confirmacao" class="form-control" name="confirmacao" value="" aria-required="true">
                                        <?= form_error('confirmacao', '<div class="text-danger" role="alert">', '</div>'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6 mb-20">
                                        <label for="perfil">Perfil de Acesso</label>
                                        <select id="perfil" name="perfil" class="form-control" aria-required="true">
                                            <?php if (isset($usuario)): ?>
                                                <option value="2" <?= ($perfil_usuario->id == 2 ? 'selected' : '') ?>>User</option>
                                                <option value="1" <?= ($perfil_usuario->id == 1 ? 'selected' : '') ?>>Administrador</option>
                                            <?php else: ?>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <select id="active" name="active" class="form-control" aria-required="true">
                                            <?php if (isset($usuario)): ?>
                                                <option value="0" <?= ($usuario->active == 0 ? 'selected' : '') ?>>Não</option>
                                                <option value="1" <?= ($usuario->active == 1 ? 'selected' : '') ?>>Sim</option>
                                            <?php else: ?>
                                ...
                                <button type="submit" class="btn btn-primary mr-2" aria-label="Salvar alterações">Salvar</button>
                                <a href="<?= base_url($this->router->fetch_class()); ?>" class="btn btn-info" aria-label="Voltar para a lista de usuários">Voltar</a>
                            </form>
                        </div>
                    </div>
                </div>
