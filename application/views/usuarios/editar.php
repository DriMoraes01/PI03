                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="forms-sample" name="form_core" method="POST" aria-labelledby="formTitle">
                                        <h2 id="formTitle" class="sr-only">Formulário de Edição de Usuário</h2>
                                        <div class="form-group row">
                                            <div class="col-md-6 mb-20">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 mb-20">
                                                <label for="senha">Senha</label>
                                                <input type="password" id="senha" class="form-control" name="password" value="" aria-required="true">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 mb-20">
                                                ...
                                                <select name="perfil" id="perfil" class="form-control" aria-required="true">
                                                    <?php if (isset($usuario)): ?>
                                                        <option value="2" <?= ($perfil_usuario->id == 2 ? 'selected' : '') ?>>User</option>
                                                        <option value="1" <?= ($perfil_usuario->id == 1 ? 'selected' : '') ?>>Administrador</option>
                                                    <?php else: ?>
                                            ...
                                            <div class="col-md-6 mb-20">
                                                ...
                                                <select name="active" id="active" class="form-control" aria-required="true">
                                                    <?php if (isset($usuario)): ?>
                                                        <option value="0" <?= ($usuario->active == 0 ? 'selected' : '') ?>>Não</option>
                                                        <option value="1" <?= ($usuario->active == 1 ? 'selected' : '') ?>>Sim</option>
                                                    <?php else: ?>
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2" aria-label="Salvar">Salvar</button>
                                        <a href="<?= base_url('/usuarios'); ?>" class="btn btn-info" aria-label="Voltar">Voltar</a>
                                    </form>
                                </div>
                            </div>
                        </div>
